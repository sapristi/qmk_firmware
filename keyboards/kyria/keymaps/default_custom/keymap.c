 ...
 *                                                                               generated by [keymapviz] */
    [_SYM] = LAYOUT(
      _______, KC_EXLM, KC_AT,   KC_LCBR, KC_RCBR, KC_PIPE,                                     KC_DQT,  KC_QUOT, KC_GRV,  KC_CIRC, AC_GRAV, _______,
      _______, KC_HASH, KC_DLR,  KC_LPRN, KC_RPRN, KC_AMPR,                                     KC_UNDS, KC_MINS, KC_SLSH, KC_ASTR, AC_AIGU, _______,
      _______, KC_PERC, KC_CIRC, KC_LBRC, KC_RBRC, KC_TILD, _______, _______, _______, _______, KC_PLUS, KC_EQL,  KC_BSLS, KC_PERC, AC_CIRC, _______,
